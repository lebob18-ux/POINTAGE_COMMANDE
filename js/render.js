...
tr.innerHTML = `
      ...
      <td style="width: 55px; padding: 4px 2px; text-align: center; vertical-align: middle;">
        <img src="image/${esc(r.article)}.jpg" alt="" style="width: 50px; height: 120px; object-fit: cover; border-radius: 4px; border: 1px solid var(--border); display: block; margin: 0 auto;" onerror="this.style.display='none'">
